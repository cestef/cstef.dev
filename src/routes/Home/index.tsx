            ...
            <Box sx={styles.content}>
                ...
                <Box sx={styles.buttons}>
                    <IconButton
                        size="large"
                        sx={styles.button}
                        href="https://github.com/cstefFlexin/"
                    >
                        <GitHub fontSize="large" />
                    </IconButton>
                    <IconButton size="large" sx={styles.button} href="https://twitter.com/AkaCstef">
                        <Twitter fontSize="large" />
                    </IconButton>
                    <IconButton
                        size="large"
                        sx={styles.button}
                        href="https://www.instagram.com/cstef._"
                    >
                    ...
                    <IconButton
                        size="large"
                        sx={styles.button}
                        href="https://discord.com/users/699912716474777631"
                    >
                    ...
                    <IconButton
                        size="large"
                        sx={styles.button}
                        href="https://steamcommunity.com/id/667ekip667"
                    >
