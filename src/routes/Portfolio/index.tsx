	...
	},
	{
		...
		description: (
			<>
				...
				result (Placed <b>6th</b> out of <b>1000+</b> games) and learned a lot
				of things.
			</>
		),
		time: "2022",
		...
		<Container sx={styles.root}>
			...
			>
				<Paper elevation={4} sx={styles.container}>
					...
					<Typography variant='body1' sx={styles.paragraph}>
						I love to program things to make other people's lives easier, such
						as automation of easy repetitive tasks.
					</Typography>
					<Typography variant='body1' sx={styles.paragraph}>
						When I'm not in front of my <Twemoji emoji='💻' />, I love to play
						the <Twemoji emoji='🎹' /> !
					</Typography>
				</Paper>
			</Div>
			...
			>
				<Paper sx={styles.container} elevation={4}>
					...
					<Typography variant='body1' sx={styles.paragraph}>
						...
						/>
						,{"\u00A0"}
						<ImageEmoji src={"/images/rust.png"} alt='Rust Icon' title='Rust' />{" "}
						or even{" "}
